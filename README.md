...
### 最新版本
- [DVA-v1.1.0-debug.apk](https://github.com/birdnofoots/DVA/releases/download/v1.0.0/DVA-v1.1.0-debug.apk) - 新增 ML 模型管理页面、完整导航系统
...
由于深度学习模型获取困难，当前版本采用简化方案：

| 功能 | 实现方式 | 精度 | 备注 |
|------|---------|------|------|
| 车辆检测 | YOLOv8n ONNX | ✅ 高 | 已有完整模型 |
| 车道线检测 | OpenCV 边缘检测 | ⚠️ 中 | 高速公路效果好，复杂路况一般 |
| 车牌识别 | ⏸️ 暂跳过 | — | 需要模型 |
| 变道检测 | 轨迹分析 | ⚠️ 中 | 通过车辆横向移动推断 |
...
### 车牌识别
- 当前版本暂时跳过此功能
- 后续计划接入 PaddleOCR-Lite 或 EasyOCR
...
### 最新版本
- [DVA-v1.3.0-debug.apk](https://github.com/birdnofoots/DVA/releases/download/v1.0.0/DVA-v1.3.0-debug.apk) - 简化版车道线检测

### 更新内容（v1.3.0）
- ✅ 实现简化版车道线检测（OpenCV Sobel 边缘检测）
- ✅ 备选方案：基于颜色的黄色车道线检测
- ⚠️ 注意：车牌识别功能暂时跳过
...
### 最新版本
- [DVA-v1.4.0-debug.apk](https://github.com/birdnofoots/DVA/releases/download/v1.0.0/DVA-v1.4.0-debug.apk) - Bug 修复版本

### 更新内容（v1.4.0）
- ✅ Issue #3: 修复视频分析点击后闪退
- ✅ Issue #5: 修复存储权限提示持续显示问题
- ✅ Issue #6: 修复视频Tab切换后文件夹选择丢失
- ✅ 修复设置页面截图保存路径选择无效
- ✅ 修复版本号显示问题（改为1.3.0）
- 新增 GlobalVideoState 共享状态管理
